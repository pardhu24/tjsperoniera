	...
	var thetitle = "<div class='container'>" + 
            			"<div class='row'>" +
							"<div class='col-md-12 text-center'>" +
								"<span id='loader_heart' class='glyphicon glyphicon-home animated_heart'></span><br/>" +
								"<span id='hisname'><img src='images/peroneiraWhite.png' width='300' height='auto'/></span><br>" +
								"<span id='hername'>Architects & Interior Designers</span><br>" +
							"</div>" +
						"</div>" +
					"</div>";	
